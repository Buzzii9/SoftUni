...
namespace _04._Clever_Lily
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (totalMoney >= priceForMachine)
            {
                Console.WriteLine("Yes! {0:f2}", Math.Abs(totalMoney - priceForMachine));
            }
            else
            {
                Console.WriteLine("No! {0:F2}", Math.Abs(priceForMachine - totalMoney));
            }
